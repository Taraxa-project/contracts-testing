...
interface IIngesterProxy {
    ...
    event GroupManagerContractAddressUpdated(
        address newGroupManagerContractAddress
    );
    event RegistrationContractAddressUpdated(
        address newGroupManagerContractAddress
    );
    event DataGatheringContractAddressUpdated(
        address newGroupManagerContractAddress
    );
    ...
    function getIngesterAddressFromIndex(
        uint256 index
    ) external view returns (address);

    function getIngesterToController(
        address ingesterAddress
    ) external view returns (IIngesterRegistration.IngesterToController memory);

    function getControllerIngesters(
        address controllerAddress
    ) external view returns (IIngesterRegistration.Ingester[] memory);
    ...
    function setMaxNumberIngesterPerGroup(
    ...
    function distributeGroupPostUnregistration(
    ...
    function getIpfsHashes(
        address ingesterAddress
    ) external view returns (IIngesterDataGathering.IpfsHash memory);
}
